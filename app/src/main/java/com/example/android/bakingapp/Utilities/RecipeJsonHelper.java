...
public class RecipeJsonHelper {
    ...
    public static String getIngredientsStringForRecipe(JSONObject recipeObj) {
    ...
    //Get the JSONObject for a particular recipe
    public static JSONObject getRecipeJsonObject(int id) {
        JSONArray jsonArray = RecipeJsonHelper.getJson();
        JSONObject recipeObject = new JSONObject();
        try {
            recipeObject = jsonArray.getJSONObject(id);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return recipeObject;
    ...
    public static JSONObject getRecipeStepJsonObject(int stepPosition, JSONObject json) {
        JSONObject res = new JSONObject();
        try {
            res = json.getJSONArray(RecipeJsonHelper.STEPS)
                    .getJSONObject(stepPosition - 1);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return res;
    ...
    public static String[] getRecipeStepDescriptions(int id) {
        ...
        try {
            JSONObject recipeObject = jsonArray.getJSONObject(id);
    ...
    //Returns a Json Object created form the data given(All the data)
    public static JSONArray getJson() {
        JSONArray json = new JSONArray();

        try {
            json = new JSONArray(recipes);
        } catch (JSONException e) {
            e.printStackTrace();
        }
